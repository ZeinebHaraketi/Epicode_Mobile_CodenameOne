...
public class AddActivite extends BaseForm{
    String Imagecode;
    String filePath="";
   
   public AddActivite(Resources res,Form previous)
   {
     super("Ajouter une Activite", BoxLayout.y());
        ...
        /*
         ComboBox<Integer> cat_age = new ComboBox<>();
        cat_age.addItem(3);
        cat_age.addItem(4);
        cat_age.addItem(5);
        cat_age.addItem(6);
       ...
       //IMAGE
        ...
        Edit.addActionListener((evt) -> {
           ...
           // fi.setCat_age(Integer.valueOf(cat_age.getText()));
            ...
            sp.addActivite(fi);
            Dialog.show("Success","Activite Ajouter avec success",new Command("OK"));
